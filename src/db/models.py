...
class PeriodicTask(models.Model):
    ...
    month = models.CharField(max_length=20, default="*", verbose_name="В какой месяц вызывать")
    day_of_week = models.CharField(max_length=20, default="*", verbose_name="В какой день недели вызывать")
